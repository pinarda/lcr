...
foreach x ($arrDay)
  ncks -v $x,lat,lon -d time,1,365,91 /glade/p/cisl/asap/abaker/pepsi/ens_31/orig/daily/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h1.${x}.20810101-21001231.nc /glade/scratch/apinard/minidata/minidata_daily_${x}.nc
end

foreach x ($arrMonth)
  ncks -v $x,lat,lon -d time,1,365,91 /glade/p/cisl/asap/abaker/pepsi/ens_31/orig/monthly/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h0.${x}.208101-210012.nc /glade/scratch/apinard/minidata/minidata_monthly_${x}.nc
end