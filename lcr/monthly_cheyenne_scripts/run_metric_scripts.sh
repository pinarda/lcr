...
#set arr3D = (OMEGAT OMEGA VU VQ V VT VV UQ U UU QRL CCN3 ABSORB EXTINCT RELHUM QRS Q DCQ DTCOND CLOUD Z3 VD01 CLDICE DTV T ICLDTWP NUMICE TOT_CLD_VISTAU CLDLIQ IWC ICLDIWP ICIMR CO2 ICWMR WSUB CO2_FFF NUMLIQ FICE ANSNOW CO2_OCN CO2_LND AQSNOW AWNI AREI FREQS FREQI ANRAIN AWNC AQRAIN AREL FREQL FREQR)
