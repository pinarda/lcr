...
python main2.py --onlydata True --runonlydata True --metric dssim -j RF_local_dssim.json --labelsonly True
python main2.py --onlydata False --runonlydata False --metric dssim -j RF_local_dssim.json --labelsonly True
