...
class Objective(BaseObjective):
    ...
    def train(self, trial, conf):
        ...
        # this time, use a random forest model, not a CNN
        model = sklearn.ensemble.RandomForestRegressor(n_estimators=100, max_depth=10, random_state=seed)
        ...
        # Example of how to check if a trial could be pruned (manually)
