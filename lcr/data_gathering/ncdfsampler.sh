...
set arrDay= (TS)
foreach x ($arrDay)
  ncks -O -v $x,lat,lon -d time,1,100,1 /glade/p/cisl/asap/abaker/pepsi/ens_31/orig/daily/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h1.${x}.20060101-20801231.nc /glade/scratch/apinard/zfp/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h1.${x}.20060101-20801231.nc
  foreach y ($compressDirs)
    ncks -O -v $x,lat,lon -d time,1,100,1 /glade/p/cisl/asap/abaker/pepsi/ens_31/lossy/daily/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h1.${x}.TS.20060101-20801231.nc /glade/scratch/apinard/zfp/zfp_p_${y}/b.e11.BRCP85C5CNBDRD.f09_g16.031.cam.h1.${x}.20060101-20801231.nc
  end
end
