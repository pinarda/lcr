...
\def\myConfMat{{
{0, 0, 0,753,13,130,58,0, 0},
{0, 0,  0,665,203,288,49,0,0},  %row 1
{0, 0, 0,753,13,130,58,0, 0},
{0, 0,  0,665,203,288,49,0,0},  %row 1
{0, 0,    0, 48,  5, 10, 84, 0, 0},  %row 2 3
{0, 0,   0, 408,  12, 29, 219, 0, 0},  %row 4
{0, 0,    0, 20, 20,52,156, 0, 0},  %row 5
{0, 0,    0, 2, 6,17,42, 0, 0},  %row 6
{0, 0,    0,8,1,4, 57, 0, 0},  %row 7
}}
...
\def\classNames{{"zfp\_p\_10","zfp\_p\_12","zfp\_p\_14","zfp\_p\_16","zfp\_p\_18","zfp\_p\_20","zfp\_p\_22","zfp\_p\_24","zfp\_p\_26"}} %class names. Adapt at will

\def\numClasses{9} %number of classes. Could be automatic, but you can change it for tests.

\def\myScale{1.4} % 1.5 is a good scale. Values under 1 may need smaller fonts!
\begin{tikzpicture}[
    scale = \myScale,
...
\coordinate (yaxis) at (-0.8,0.5-\numClasses/2);  %must adapt if class labels are wider!
\coordinate (xaxis) at (0.5+\numClasses/2, -\numClasses-1.25); %id. for non horizontal labels!
\node [vertical label] at (yaxis) {Target Class Class};
\node []               at (xaxis) {Output Class};
\end{tikzpicture}
\end{document}