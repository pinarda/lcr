...
if __name__ == '__main__':
    ...
    with open('RF_template_sanity.json', 'r') as f:
        config = json.load(f)
    ...
    newnames = ["test_same_ensemble", "test_same_ensemble2"]
    newvars = [["ICEFRAC"], ["PRECT"]]
    # newcomps = [["zfp_p_10", "zfp_p_12", "zfp_p_14", "zfp_p_16", "zfp_p_18", "zfp_p_20", "zfp_p_22", "zfp_p_24"]]
    newcomps = [["zfp_p_10", "zfp_p_14", "zfp_p_18", "zfp_p_22"], ["zfp_p_10", "zfp_p_14", "zfp_p_18", "zfp_p_22"]]
    newtimes = [[100], [100]]
