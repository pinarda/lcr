...
foreach x ($arrname)
  ...
  cat batch_scripts/cheyenne_batch_$x.sh | sed "s/-j './batch_scripts\/.json'/-j '.\/batch_scripts\/sz_dssim_scripts\/$x.json'/" > batch_scripts/sz_dssim_scripts/cheyenne_batch_$x.sh
end