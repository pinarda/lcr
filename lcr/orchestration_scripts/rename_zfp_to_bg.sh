...
foreach x ($arrname)
  cat batch_scripts/$x.json | sed 's/\["zfp_p_8", "zfp_p_10", "zfp_p_12", "zfp_p_14", "zfp_p_16", "zfp_p_18", "zfp_p_20", "zfp_p_22", "zfp_p_24"\]/["bg_2", "bg_3", "bg_4", "bg_5", "bg_6", "bg_7"]/' | sed 's/daily_zfp_hdf5/daily_bg/' > batch_scripts/bg_dssim_scripts/$x.json
