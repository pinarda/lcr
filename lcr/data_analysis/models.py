...
if __name__ == "__main__":
    ...
    x1, x2, y1, y2, idx1, idx2 = train_test_split(daily_df[daily_df["levels"] == 14], daily_df[daily_df["levels"]==14]["levels"], daily_df[daily_df["levels"] == 14].index, test_size=0.25, random_state=3)
    daily_df.drop(index=idx1, inplace=True)
    x1, x2, y1, y2, idx1, idx2 = train_test_split(monthly_df[monthly_df["levels"] == 14], monthly_df[monthly_df["levels"]==14]["levels"], monthly_df[monthly_df["levels"] == 14].index, test_size=0.25, random_state=3)
