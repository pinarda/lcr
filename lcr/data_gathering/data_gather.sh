...
#    set id2 = `python ~/lcr/lcr/data_gathering/compute_batch.py -o ~/lcr/data/${prefix}_calcs/${prefix}_daily_metrics.csv -j ${prefix}_diff_$y.json -ld -tt 2 -v`
    python ~/lcr/lcr/data_gathering/compute_batch.py -o ~/lcr/data/${prefix}_calcs/${prefix}_daily_metrics.csv -j ${prefix}_diff_$y.json -ld -tt 2 -v
