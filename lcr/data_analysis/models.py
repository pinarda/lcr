...
if __name__ == "__main__":
    ...
    if argv_featureloc is not None:
        ...
        features = ["mean","variance","ns_con_var","w_e_first_differences","w_e_first_differences_max","n_s_first_differences", "n_s_first_differences_max","quantile","fftmax","fftratio","vfftmax","vfftratio","magnitude_range", "magnitude_diff_ew", "magnitude_diff_ns", "entropy", "real_information_cutoff"]
    if argv_dailyloc is not None:
